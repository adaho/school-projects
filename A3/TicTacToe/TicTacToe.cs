//Assignment 3, Ada Ho, CIS345 3:00pm
using System;
...
namespace TicTacToeGame
{
    class TicTacToe
    {
        ...
        private static void TestForWin()
        {
            ...
            bool gameWonByRowCols = (GameWonByCols(currentPlayer) || GameWonByRows(currentPlayer));            
            ...
            bool gameWon = (gameWonByRowCols || gameWonByDiags);
        ...
        private static void PlayNextMove()
        {
           ...
           columnNumber = Convert.ToInt32(Console.ReadLine());
            ...
            if (TicTacToe.ValidLocation(rowNumber, columnNumber))
            {
                // Part 8.2
